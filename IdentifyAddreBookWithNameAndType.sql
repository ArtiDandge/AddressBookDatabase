...
update [dbo].[address_book] set addressbook_name = 'AddressBook4' where first_name = 'Neha'
update [dbo].[address_book] set addressbook_name = 'AddressBook5' where first_name = 'Smita'
update [dbo].[address_book] set addressbook_name = 'AddressBook6' where first_name = 'Vinita'
update [dbo].[address_book] set addressbook_name = 'AddressBook7' where first_name = 'Swati'
...
select first_name, last_name from [dbo].[address_book] where addressbook_name = 'AddressBook6'
